...
export default function Footer() {
  return (
    <footer className="bg-[#1A1008] text-[#D4B896]">
      <div className="max-w-6xl mx-auto px-5 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-[9px] tracking-[0.22em] text-[#7A6855] uppercase mb-4">
            ...
            <div className="flex gap-3 mt-5">
              <a
                ...
                className="text-[#7A6855] hover:text-[#D95F2A] transition-colors"
          ...
          {/* Links */}
          <div>
            <h4 className="text-xs tracking-[0.18em] uppercase text-[#D4B896] mb-5 font-medium">
              Pages
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-[#7A6855] hover:text-[#D4B896] transition-colors"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-[#7A6855]">Dallas & Houston, Texas</span>
              </li>
              <li className="flex items-start gap-3">
            ...
            <p className="mt-5 text-xs text-[#7A6855]">
        ...
        <div className="border-t border-[#2D2010] mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-xs text-[#7A6855]">@lumii.cooks</p>
        </div>
      </div>
    </footer>
  );
